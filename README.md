...
> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the cms-experience-assistant public boundary. I
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-experience-assistant-filament?sort=semver)](https://github.com/liberusoftware/module-cms-experience-assistant-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-experience-assistant-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-experience-assistant-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-experience-assistant-filament
```
...
<a href="https://github.com/liberusoftware/module-cms-experience-assistant-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-experience-assistant-filament" alt="Contributors to liberusoftware/module-cms-experience-assistant-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-experience-assistant-filament/graphs/contributors).
